<table class="table table-striped" id="table-manajemen-barang">
    <thead>
        <tr>
    ...
    <?php 
        ...
        <tr>
            ...
            <td><?= $row['supplier'] ?></td>
            <td>
                <button type="button" class="btn btn-warning btn-sm btnedit<?= $row['id_barang'] ?>"
                    onclick="edit('<?= $row['id_barang'] ?>')">
                    <i class="fas fa-edit"></i>
                </button>
                <button type="button" class="btn btn-danger btn-sm"
                    onclick="hapus('<?= $row['id_barang'] ?>', '<?= $row['nama_barang']; ?>')">
